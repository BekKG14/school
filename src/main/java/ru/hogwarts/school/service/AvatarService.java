...
public void uploadAvatar(Long studentId, MultipartFile file) throws IOException{
    ...
    Avatar avatar = findStudentsAvatar(studentId);
    ...
    public Avatar getAvatarFromFile(Long studentsId) throws IOException {
        Avatar avatar = findStudentsAvatar(studentsId);
        avatar.setData(Files.readAllBytes(Path.of(avatar.getFilePath())));
        return avatar;
}
